...
RouteModel::Node* RoutePlanner::NextNode() 
{
    ...
    std::sort(open_list.begin(), open_list.end(), [](const auto &firstValue, const auto &secondValue)
    {
        return firstValue->h_value + firstValue->g_value > secondValue->h_value + secondValue->g_value;
    });
